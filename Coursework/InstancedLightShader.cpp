...
bool InstancedLightShader::Initialise(HWND hwnd)
{
	...
	AddLayout("TEXCOORD", 2, DXGI_FORMAT_R32G32_FLOAT, 1, sizeof(D3DXVECTOR3), D3D11_INPUT_PER_INSTANCE_DATA, 1);
	AddLayout("TEXCOORD", 3, DXGI_FORMAT_R32G32_FLOAT, 1, sizeof(D3DXVECTOR3) + sizeof(D3DXVECTOR2), D3D11_INPUT_PER_INSTANCE_DATA, 1);
